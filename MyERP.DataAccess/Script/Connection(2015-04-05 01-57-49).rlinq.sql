...
-- dropping unknown column "culute_ui_id"
ALTER TABLE "client" DROP COLUMN "culute_ui_id"
;

-- dropping unknown column "culture_ui_id"
ALTER TABLE "organization" DROP COLUMN "culture_ui_id"
;
