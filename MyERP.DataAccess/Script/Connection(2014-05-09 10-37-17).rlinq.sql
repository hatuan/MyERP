...
ALTER TABLE "general_journal_setup" ADD COLUMN "general_journal_number_seq_id" uuid
;

UPDATE "general_journal_setup" SET "general_journal_number_seq_id" = '00000000-0000-0000-0000-000000000000'
;

ALTER TABLE "general_journal_setup" ALTER COLUMN "general_journal_number_seq_id" SET  NOT NULL
;

-- dropping unknown column "default_document_type_1_number_seq_id"
ALTER TABLE "general_journal_setup" DROP COLUMN "default_document_type_1_number_seq_id"
;

ALTER TABLE "general_journal_setup" ADD CONSTRAINT "ref_gnrl_jrnl_stp_nmbr_sequence" FOREIGN KEY ("general_journal_number_seq_id") REFERENCES "number_sequence"("id")
;
