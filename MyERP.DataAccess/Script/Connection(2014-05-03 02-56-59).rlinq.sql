...
-- Dropping index 'idx_general_journal_line_no1' which is not configured in OpenAccess but exists on the database.
DROP INDEX "idx_general_journal_line_no1" CASCADE
;
...
-- Column was read from database as: "default_document_type_1_no_id" uuid null
-- modify column for field _noSeries
UPDATE "general_journal_setup"
   SET "default_document_type_1_no_id" = '00000000-0000-0000-0000-000000000000'
 WHERE "default_document_type_1_no_id" IS NULL
;

ALTER TABLE "general_journal_setup" ALTER COLUMN "default_document_type_1_no_id" TYPE uuid USING "default_document_type_1_no_id"::uuid
;

ALTER TABLE "general_journal_setup" ALTER COLUMN "default_document_type_1_no_id" SET NOT NULL
;
