...
CREATE TABLE "job" (
    ...
    "date2" timestamp NOT NULL,             -- _date2
    "date0" timestamp NOT NULL,             -- _date0
    "code" text NOT NULL,                   -- _ma_vv
    CONSTRAINT "pk_job" PRIMARY KEY ("code")
);
...
CREATE TABLE "organization" (
    ...
    "id" uuid NOT NULL,                     -- _id
    "code" text NOT NULL,                   -- _code
    "client_id" uuid NOT NULL,              -- Client__organization
...
CREATE TABLE "session" (
    ...
    "organization_id" uuid,                 -- _organizationId
...
CREATE TABLE "transaction_document" (
    ...
    "ma_dvcs" uuid NOT NULL,                -- _Ma_Dvcs
    "ma_ct" text NOT NULL,                  -- _Ma_Ct
    "date2" timestamp NOT NULL,             -- _Date2
    "date0" timestamp NOT NULL,             -- _Date0
...
CREATE TABLE "user" (
    "password_question" text NOT NULL,      -- _passwordQuestion
    "password_answer" text NOT NULL,        -- _passwordAnswer
    ...
    "last_login_ip" text NOT NULL,          -- _lastLoginIp
    "last_login_date" timestamp NOT NULL,   -- _lastLoginDate
    "last_locked_out_reason" text NOT NULL, -- _lastLockedOutReason
    "last_locked_out_date" timestamp NOT NULL, -- _lastLockedOutDate
    "is_locked_out" bool NOT NULL,          -- _isLockedOut
    "is_activated" bool NOT NULL,           -- _isActivated
    "id" uuid NOT NULL,                     -- _id
    "full_name" text NOT NULL,              -- _fullName
    "email" text NOT NULL,                  -- _email
