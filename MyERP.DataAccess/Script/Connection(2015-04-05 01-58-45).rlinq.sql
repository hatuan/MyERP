...
-- add column for field _cultureUIId
ALTER TABLE "user" ADD COLUMN "culture_ui_id" varchar
;

UPDATE "user" SET "culture_ui_id" = ' '
;

ALTER TABLE "user" ALTER COLUMN "culture_ui_id" SET  NOT NULL
;

-- dropping unknown column "CultureUIId"
ALTER TABLE "user" DROP COLUMN "CultureUIId"
;
