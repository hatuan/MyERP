...
-- add column for field _currencyLCYId
ALTER TABLE "client" ADD COLUMN "currency_lcy_id" uuid
;

-- dropping unknown column "currency_id"
ALTER TABLE "client" DROP COLUMN "currency_id"
;
