...
-- add column for field _lineNo
ALTER TABLE "general_journal_line" ADD COLUMN "line_no" int8
;

UPDATE "general_journal_line" SET "line_no" = 0
;

ALTER TABLE "general_journal_line" ALTER COLUMN "line_no" SET  NOT NULL
;

-- dropping unknown column "lineno"
ALTER TABLE "general_journal_line" DROP COLUMN "lineno"
;
