...
ALTER TABLE "currency_convert_rate" ADD COLUMN "exchange_rate_amount" int8
;

UPDATE "currency_convert_rate" SET "exchange_rate_amount" = 0
;

ALTER TABLE "currency_convert_rate" ALTER COLUMN "exchange_rate_amount" SET  NOT NULL
;

-- add column for field _relationalExchRateAmount
ALTER TABLE "currency_convert_rate" ADD COLUMN "relational_exch_rate_amount" int8
;

UPDATE "currency_convert_rate" SET "relational_exch_rate_amount" = 0
;

ALTER TABLE "currency_convert_rate" ALTER COLUMN "relational_exch_rate_amount" SET  NOT NULL
;

-- dropping unknown column "divide_rate"
ALTER TABLE "currency_convert_rate" DROP COLUMN "divide_rate"
;

-- dropping unknown column "multiply_rate"
ALTER TABLE "currency_convert_rate" DROP COLUMN "multiply_rate"
;
