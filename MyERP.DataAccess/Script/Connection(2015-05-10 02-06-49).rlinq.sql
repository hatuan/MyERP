...
-- Column was read from database as: "amount_decimal_places" varchar not null
-- modify column for field _amountDecimalPlaces
ALTER TABLE "client" ALTER COLUMN "amount_decimal_places" TYPE int2 USING "amount_decimal_places"::int2
;

-- Column was read from database as: "unit-amount_decimal_places" varchar not null
-- modify column for field _unitAmountDecimalPlaces
ALTER TABLE "client" ALTER COLUMN "unit-amount_decimal_places" TYPE int2 USING "unit-amount_decimal_places"::int2
;
