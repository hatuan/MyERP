...
-- Column was read from database as: "document_type" varchar not null
-- modify column for field _documentType
ALTER TABLE "general_journal_document" ALTER COLUMN "document_type" TYPE int4 USING "document_type"::int4
;

-- Column was read from database as: "document_type" varchar not null
-- modify column for field _documentType
ALTER TABLE "general_journal_line" ALTER COLUMN "document_type" TYPE int4 USING "document_type"::int4
;
