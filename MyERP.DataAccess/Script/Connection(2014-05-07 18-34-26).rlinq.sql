ALTER TABLE "general_journal_document" DROP CONSTRAINT "ref_gnrl_jrnl_document_currency" CASCADE
;
...
-- Column was read from database as: "currency_id" uuid not null
-- modify column for field _currency
ALTER TABLE "general_journal_document" ALTER COLUMN "currency_id" TYPE uuid USING "currency_id"::uuid
;

ALTER TABLE "general_journal_document" ALTER COLUMN "currency_id" DROP NOT NULL
;

-- Column was read from database as: "currency_exchange_rate" numeric(38,20) not null
-- modify column for field _currencyExchangeRate
ALTER TABLE "general_journal_document" ALTER COLUMN "currency_exchange_rate" TYPE numeric(38,20) USING "currency_exchange_rate"::numeric(38,20)
;

ALTER TABLE "general_journal_document" ALTER COLUMN "currency_exchange_rate" DROP NOT NULL
;
...
-- Column was read from database as: "currency_exchange_rate" numeric(38,20) not null
-- modify column for field _currencyExchangeRate
ALTER TABLE "general_journal_line" ALTER COLUMN "currency_exchange_rate" TYPE numeric(38,20) USING "currency_exchange_rate"::numeric(38,20)
;

ALTER TABLE "general_journal_line" ALTER COLUMN "currency_exchange_rate" DROP NOT NULL
;

-- Column was read from database as: "currency_id" uuid not null
-- modify column for field _currencyId
ALTER TABLE "general_journal_line" ALTER COLUMN "currency_id" TYPE uuid USING "currency_id"::uuid
;

ALTER TABLE "general_journal_line" ALTER COLUMN "currency_id" DROP NOT NULL
;
