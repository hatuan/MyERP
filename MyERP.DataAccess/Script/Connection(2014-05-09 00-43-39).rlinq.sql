...
-- Column was read from database as: "currency_exchange_rate" numeric(38,20) null
-- modify column for field _currencyExchangeRate
UPDATE "general_journal_document"
   SET "currency_exchange_rate" = 0
 WHERE "currency_exchange_rate" IS NULL
;
...
ALTER TABLE "general_journal_document" ALTER COLUMN "currency_exchange_rate" SET NOT NULL
;
