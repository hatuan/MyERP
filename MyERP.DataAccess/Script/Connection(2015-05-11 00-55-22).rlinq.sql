...
ALTER TABLE "client" ADD COLUMN "rec_modified" timestamp
;

UPDATE "client" SET "rec_modified" = current_timestamp
;

ALTER TABLE "client" ALTER COLUMN "rec_modified" SET  NOT NULL
;

-- add column for field _user1
ALTER TABLE "client" ADD COLUMN "rec_modified_by" uuid
;

UPDATE "client" SET "rec_modified_by" = '00000000-0000-0000-0000-000000000000'
;

ALTER TABLE "client" ALTER COLUMN "rec_modified_by" SET  NOT NULL
;
