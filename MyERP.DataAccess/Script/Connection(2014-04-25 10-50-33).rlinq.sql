...
-- add column for field _fixAssetId
ALTER TABLE "general_journal_line" ADD COLUMN "fix_asset_id" uuid
;
...
-- dropping unknown column "cor_account_type"
ALTER TABLE "general_journal_line" DROP COLUMN "cor_account_type"
;

-- dropping unknown column "account_type"
ALTER TABLE "general_journal_line" DROP COLUMN "account_type"
;
