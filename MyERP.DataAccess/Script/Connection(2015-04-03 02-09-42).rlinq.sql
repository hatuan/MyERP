...
-- add column for field _cultureId
ALTER TABLE "client" ADD COLUMN "culture_id" varchar
;

UPDATE "client" SET "culture_id" = ' '
;

ALTER TABLE "client" ALTER COLUMN "culture_id" SET  NOT NULL
;

-- add column for field _culuteUIId
ALTER TABLE "client" ADD COLUMN "culute_ui_id" varchar
;

UPDATE "client" SET "culute_ui_id" = ' '
;

ALTER TABLE "client" ALTER COLUMN "culute_ui_id" SET  NOT NULL
;

-- add column for field _cultureId
ALTER TABLE "organization" ADD COLUMN "culture_id" varchar
;

UPDATE "organization" SET "culture_id" = ' '
;

ALTER TABLE "organization" ALTER COLUMN "culture_id" SET  NOT NULL
;

-- add column for field _cultureUIId
ALTER TABLE "organization" ADD COLUMN "culture_ui_id" varchar
;

UPDATE "organization" SET "culture_ui_id" = ' '
;

ALTER TABLE "organization" ALTER COLUMN "culture_ui_id" SET  NOT NULL
;
