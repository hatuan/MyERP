...
{
    [System.ComponentModel.DataAnnotations.MetadataTypeAttribute(typeof(BusinessRelationSector.BusinessRelationSectorMetadata))]
    public partial class BusinessRelationSector
    {
        ...
        internal sealed class BusinessRelationSectorMetadata
        {
            public BusinessRelationSectorMetadata()
            {
            }
            ...
            [System.ComponentModel.DataAnnotations.Association("BusinessRelationSector-Client-Association", "ClientId", "ClientId")]
            public Client Client { get; set; }

            [System.ComponentModel.DataAnnotations.Association("BusinessRelationSector-Organization-Association", "OrganizationId", "Id")]
            public Organization Organization { get; set; }

            [System.ComponentModel.DataAnnotations.Association("BusinessRelationSector-User-Created-Association", "RecCreatedById", "Id")]
            public User RecCreatedByUser { get; set; }

            [System.ComponentModel.DataAnnotations.Association("BusinessRelationSector-User-Modified-Association", "RecModifiedById", "Id")]
    ...
    {
        public MappingConfiguration<BusinessRelationSector> GetBusinessRelationSectorMappingConfiguration()
        {
            MappingConfiguration<BusinessRelationSector> configuration = this.GetBusinessRelationSectorClassConfiguration();
            this.PrepareBusinessRelationSectorPropertyConfigurations(configuration);
            this.PrepareBusinessRelationSectorAssociationConfigurations(configuration);

            return configuration;
        }

        public MappingConfiguration<BusinessRelationSector> GetBusinessRelationSectorClassConfiguration()
        {
            MappingConfiguration<BusinessRelationSector> configuration = new MappingConfiguration<BusinessRelationSector>();
            configuration.MapType(x => new { }).WithConcurencyControl(OptimisticConcurrencyControlStrategy.Version).ToTable("business_relation_sector");

            return configuration;
        }

        public void PrepareBusinessRelationSectorPropertyConfigurations(MappingConfiguration<BusinessRelationSector> configuration)
        {
        ...
        public void PrepareBusinessRelationSectorAssociationConfigurations(MappingConfiguration<BusinessRelationSector> configuration)
        {
