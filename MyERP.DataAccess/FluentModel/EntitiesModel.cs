...
namespace MyERP.DataAccess
{
    public partial class EntitiesModel : OpenAccessContext, IEntitiesModelUnitOfWork
    {
        ...
        public IQueryable<BusinessRelationType> BusinessRelationTypes
        {
            get { return this.GetAll<BusinessRelationType>(); }
        }

        public IQueryable<BusinessRelationSector> BusinessRelationSectors
        {
            get { return this.GetAll<BusinessRelationSector>(); }
        }
    ...
    public interface IEntitiesModelUnitOfWork : IUnitOfWork
    {
        ...
        IQueryable<BusinessRelationType> BusinessRelationTypes { get; }
        IQueryable<BusinessRelationSector> BusinessRelationSectors { get; }
    }
}
