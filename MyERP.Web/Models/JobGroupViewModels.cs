...
namespace MyERP.Web.Models
{
    ...
    public class JobGroupEditViewModel
    {
        ...
        [Required]
        [Display(Name = "Code")]
        [Remote("ExtCheckDuplicateJobGroup", "Validation", AreaReference.UseRoot, AdditionalFields = "Id", ErrorMessage = "Code already exists. Please specify another one.")]
    ...
    public class JobGroupLookupViewModel
    {
        [Required]
        public Int64 Id { get; set; }
