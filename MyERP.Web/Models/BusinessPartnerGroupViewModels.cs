...
namespace MyERP.Web.Models
{
    ...
    public class BusinessPartnerGroupEditViewModel
    {
        ...
        [Required]
        [Display(Name = "Code")]
        [Remote("ExtCheckDuplicateBusinessPartnerGroup", "Validation", AreaReference.UseRoot, AdditionalFields = "Id", ErrorMessage = "Product code already exists. Please specify another one.")]
