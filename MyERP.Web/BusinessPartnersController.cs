...
{
    /// <summary>
    /// Web API Controller for BusinessPartners entity defined in MyERP.DataAccess.EntitiesModel data model
    /// </summary>
    public partial class BusinessPartnersController : OpenAccessBaseApiController<MyERP.DataAccess.BusinessPartner, MyERP.DataAccess.EntitiesModel>
    {
        /// <summary>
        ...
        {
            this.repository = new BusinessPartnerRepository();
        }
        ...
        public BusinessPartnersController(IOpenAccessBaseRepository<MyERP.DataAccess.BusinessPartner , MyERP.DataAccess.EntitiesModel> repository)
        {
        ...
        public virtual MyERP.DataAccess.BusinessPartner Get(Guid id)
        {
            MyERP.DataAccess.BusinessPartner entity = repository.GetBy(m => m.Id == id);
        ...
        public virtual HttpResponseMessage Put(Guid id, MyERP.DataAccess.BusinessPartner entity)
        {
                        if (entity == null ||
                id != entity.Id)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, MyERP.DataAccess.BusinessPartner entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<MyERP.DataAccess.BusinessPartner>(httpStatusCode, entityToEmbed);
