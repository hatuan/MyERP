...
namespace MyERP.Web
{
    ...
    public partial class AccountsController : OpenAccessBaseApiController<MyERP.DataAccess.Account, MyERP.DataAccess.EntitiesModel>
    {
        ...
        public AccountsController(IOpenAccessBaseRepository<MyERP.DataAccess.Account , MyERP.DataAccess.EntitiesModel> repository)
        {
        ...
        public virtual MyERP.DataAccess.Account Get(Guid id)
        {
            MyERP.DataAccess.Account entity = repository.GetBy(m => m.Id == id);
        ...
        public virtual HttpResponseMessage Put(Guid id, MyERP.DataAccess.Account entity)
        {
            if (entity == null ||
                id != entity.Id)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, MyERP.DataAccess.Account entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<MyERP.DataAccess.Account>(httpStatusCode, entityToEmbed);
