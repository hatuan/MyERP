...
{
    /// <summary>
    /// Web API Controller for Modules entity defined in MyERP.DataAccess.EntitiesModel data model
    /// </summary>
    public partial class ModulesController : OpenAccessBaseApiController<MyERP.DataAccess.Module, MyERP.DataAccess.EntitiesModel>
    {
        /// <summary>
        ...
        public ModulesController(IOpenAccessBaseRepository<MyERP.DataAccess.Module , MyERP.DataAccess.EntitiesModel> repository)
        {
        ...
        public virtual MyERP.DataAccess.Module Get(Int64 id)
        {
            MyERP.DataAccess.Module entity = repository.GetBy(m => m.Id == id);
        ...
        public virtual HttpResponseMessage Put(Int64 id, MyERP.DataAccess.Module entity)
        {
                        if (entity == null ||
                id != entity.Id)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, MyERP.DataAccess.Module entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<MyERP.DataAccess.Module>(httpStatusCode, entityToEmbed);
