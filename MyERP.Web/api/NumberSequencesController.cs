...
{
    /// <summary>
    /// Web API Controller for NumberSequences entity defined in MyERP.DataAccess.EntitiesModel data model
    /// </summary>
    public partial class NumberSequencesController : OpenAccessBaseApiController<MyERP.DataAccess.NumberSequence, MyERP.DataAccess.EntitiesModel>
    {
        ...
        public virtual MyERP.DataAccess.NumberSequence Get(Guid id)
        {
            MyERP.DataAccess.NumberSequence entity = repository.GetBy(m => m.Id == id);
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, MyERP.DataAccess.NumberSequence entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<MyERP.DataAccess.NumberSequence>(httpStatusCode, entityToEmbed);
