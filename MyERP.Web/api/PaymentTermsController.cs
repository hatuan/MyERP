...
{
    /// <summary>
    /// Web API Controller for PaymentTerms entity defined in MyERP.DataAccess.EntitiesModel data model
    /// </summary>
    public partial class PaymentTermsController : OpenAccessBaseApiController<MyERP.DataAccess.PaymentTerm, MyERP.DataAccess.EntitiesModel>
    {
        /// <summary>
        ...
        public PaymentTermsController(IOpenAccessBaseRepository<MyERP.DataAccess.PaymentTerm , MyERP.DataAccess.EntitiesModel> repository)
        {
        ...
        public virtual MyERP.DataAccess.PaymentTerm Get(Guid id)
        {
            MyERP.DataAccess.PaymentTerm entity = repository.GetBy(m => m.Id == id);
        ...
        public virtual HttpResponseMessage Put(Guid id, MyERP.DataAccess.PaymentTerm entity)
        {
                        if (entity == null ||
                id != entity.Id)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, MyERP.DataAccess.PaymentTerm entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<MyERP.DataAccess.PaymentTerm>(httpStatusCode, entityToEmbed);
