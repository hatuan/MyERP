...
namespace MyERP.Web.Api
{
    ...
    public partial class ClientsController : EntityBaseApiController<MyERP.DataAccess.Client, MyERP.DataAccess.EntitiesModel>
    {
        ...
        public override IQueryable<Client> Get()
        {
            ...
            //return this.repository.DataContext.Set<Client>();
        }

        public override Client Get(long id)
        {
            throw new HttpResponseException(HttpStatusCode.NotImplemented);

            //var entity = repository.DataContext.Set<Client>().Where(x => x.Id == id).FirstOrDefault();
            //if (entity == null)
            //{
        ...
        public override HttpResponseMessage Put(long id, Client entity)
        {
            return new HttpResponseMessage(HttpStatusCode.NotImplemented);
        }

        public override HttpResponseMessage Post(Client entity)
        {
            return new HttpResponseMessage(HttpStatusCode.NotImplemented);
        }
