...
{
    /// <summary>
    /// Web API Controller for Jobs entity defined in MyERP.DataAccess.EntitiesModel data model
    /// </summary>
    public partial class JobsController : OpenAccessBaseApiController<MyERP.DataAccess.Job, MyERP.DataAccess.EntitiesModel>
    {
        /// <summary>
        ...
        public JobsController(IOpenAccessBaseRepository<MyERP.DataAccess.Job , MyERP.DataAccess.EntitiesModel> repository)
        {
        ...
        public virtual MyERP.DataAccess.Job Get(Guid id)
        {
            MyERP.DataAccess.Job entity = repository.GetBy(m => m.Id == id);
        ...
        public virtual HttpResponseMessage Put(Guid id, MyERP.DataAccess.Job entity)
        {
                        if (entity == null ||
                id != entity.Id)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, MyERP.DataAccess.Job entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<MyERP.DataAccess.Job>(httpStatusCode, entityToEmbed);
