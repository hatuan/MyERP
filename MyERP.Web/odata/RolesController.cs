...
namespace MyERP.Web.Odata
{
    ...
    public partial class RolesController : BaseOdataController<MyERP.DataAccess.Role, MyERP.DataAccess.EntitiesModel>
    {
        /// <summary>
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, MyERP.DataAccess.Role entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<MyERP.DataAccess.Role>(httpStatusCode, entityToEmbed);
