...
{
    /// <summary>
    /// Web API Controller for GeneralJournalSetups entity defined in MyERP.DataAccess.EntitiesModel data model
    /// </summary>
    public partial class GeneralJournalSetupsController : OpenAccessBaseApiController<MyERP.DataAccess.GeneralJournalSetup, MyERP.DataAccess.EntitiesModel>
    {
        /// <summary>
        /// Constructor used by the Web API infrastructure.
        /// </summary>
        public GeneralJournalSetupsController()
        {
            this.repository = new GeneralJournalSetupRepository();
        }
        ...
        public GeneralJournalSetupsController(IOpenAccessBaseRepository<MyERP.DataAccess.GeneralJournalSetup , MyERP.DataAccess.EntitiesModel> repository)
        {
        ...
        public virtual MyERP.DataAccess.GeneralJournalSetup Get(Guid id)
        {
            MyERP.DataAccess.GeneralJournalSetup entity = repository.GetBy(m => m.Id == id);
        ...
        public virtual HttpResponseMessage Put(Guid id, MyERP.DataAccess.GeneralJournalSetup entity)
        {
                        if (entity == null ||
                id != entity.Id)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, MyERP.DataAccess.GeneralJournalSetup entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<MyERP.DataAccess.GeneralJournalSetup>(httpStatusCode, entityToEmbed);
