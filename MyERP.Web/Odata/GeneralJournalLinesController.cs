...
{
    /// <summary>
    /// Web API Controller for GeneralJournalLines entity defined in MyERP.DataAccess.EntitiesModel data model
    /// </summary>
    public partial class GeneralJournalLinesController : OpenAccessBaseApiController<MyERP.DataAccess.GeneralJournalLine, MyERP.DataAccess.EntitiesModel>
    {
        /// <summary>
        /// Constructor used by the Web API infrastructure.
        /// </summary>
        public GeneralJournalLinesController()
        {
            this.repository = new GeneralJournalLineRepository();
        }
        ...
        public GeneralJournalLinesController(IOpenAccessBaseRepository<MyERP.DataAccess.GeneralJournalLine , MyERP.DataAccess.EntitiesModel> repository)
        {
        ...
        public virtual MyERP.DataAccess.GeneralJournalLine Get(Guid id)
        {
            MyERP.DataAccess.GeneralJournalLine entity = repository.GetBy(m => m.Id == id);
        ...
        public virtual HttpResponseMessage Put(Guid id, MyERP.DataAccess.GeneralJournalLine entity)
        {
                        if (entity == null ||
                id != entity.Id)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, MyERP.DataAccess.GeneralJournalLine entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<MyERP.DataAccess.GeneralJournalLine>(httpStatusCode, entityToEmbed);
