...
namespace MyERP.Web.Odata
{
    ...
    public partial class GeneralJournalDocumentsController 
    {
        public SingleResult<GeneralJournalDocument> GetGeneralJournalDocument([FromODataUri] Guid key)
        {
        ...
        public IHttpActionResult PutGeneralJournalDocument([FromODataUri] Guid key, MyERP.DataAccess.GeneralJournalDocument entity)
        {
        ...
        public IHttpActionResult Patch([FromODataUri] Guid key, Delta<MyERP.DataAccess.GeneralJournalDocument> patch)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            ...
            MyERP.DataAccess.GeneralJournalDocument entity = repository.GetBy(c => c.Id == key);
            if (entity == null)
            {
                return NotFound();
            }
        ...
        public IHttpActionResult DeleteGeneralJournalDocument([FromODataUri] Guid key)
        {
            MyERP.DataAccess.GeneralJournalDocument entity = repository.GetBy(m => m.Id == key);
            if (entity != null)
            {
        ...
        public IHttpActionResult PostGeneralJournalDocument(MyERP.DataAccess.GeneralJournalDocument entity)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            ...
            MyERP.DataAccess.GeneralJournalDocument newEntity = repository.AddNew(entity);
