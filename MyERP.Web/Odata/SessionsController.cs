...
{
    /// <summary>
    /// Web API Controller for Sessions entity defined in MyERP.DataAccess.EntitiesModel data model
    /// </summary>
    public partial class SessionsController : OpenAccessBaseApiController<MyERP.DataAccess.Session, MyERP.DataAccess.EntitiesModel>
    {
        /// <summary>
        ...
        public SessionsController(IOpenAccessBaseRepository<MyERP.DataAccess.Session , MyERP.DataAccess.EntitiesModel> repository)
        {
        ...
        public virtual MyERP.DataAccess.Session Get(Guid id)
        {
            MyERP.DataAccess.Session entity = repository.GetBy(m => m.Id == id);
        ...
        public virtual HttpResponseMessage Put(Guid id, MyERP.DataAccess.Session entity)
        {
                        if (entity == null ||
                id != entity.Id)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, MyERP.DataAccess.Session entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<MyERP.DataAccess.Session>(httpStatusCode, entityToEmbed);
