...
{
    /// <summary>
    /// Web API Controller for BusinessPartnerGroups entity defined in MyERP.DataAccess.EntitiesModel data model
    /// </summary>
    public partial class BusinessPartnerGroupsController : OpenAccessBaseApiController<MyERP.DataAccess.BusinessPartnerGroup, MyERP.DataAccess.EntitiesModel>
    {
        /// <summary>
        /// Constructor used by the Web API infrastructure.
        /// </summary>
        public BusinessPartnerGroupsController()
        {
            this.repository = new BusinessPartnerGroupRepository();
        }
        ...
        public BusinessPartnerGroupsController(IOpenAccessBaseRepository<MyERP.DataAccess.BusinessPartnerGroup , MyERP.DataAccess.EntitiesModel> repository)
        {
        ...
        public virtual MyERP.DataAccess.BusinessPartnerGroup Get(Guid id)
        {
            MyERP.DataAccess.BusinessPartnerGroup entity = repository.GetBy(m => m.Id == id);
        ...
        public virtual HttpResponseMessage Put(Guid id, MyERP.DataAccess.BusinessPartnerGroup entity)
        {
                        if (entity == null ||
                id != entity.Id)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, MyERP.DataAccess.BusinessPartnerGroup entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<MyERP.DataAccess.BusinessPartnerGroup>(httpStatusCode, entityToEmbed);
