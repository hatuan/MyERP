...
namespace MyERP.Web.Odata
{
    ...
    public partial class UsersController : BaseOdataController<MyERP.DataAccess.User, MyERP.DataAccess.EntitiesModel>
    {
        /// <summary>
        ...
        public UsersController(IBaseRepository<MyERP.DataAccess.User , MyERP.DataAccess.EntitiesModel> repository)
        {
        ...
        public virtual MyERP.DataAccess.User Get(long id)
        {
            MyERP.DataAccess.User entity = repository.GetBy(m => m.Id == id);
        ...
        public virtual HttpResponseMessage Put(long id, MyERP.DataAccess.User entity)
        {
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, MyERP.DataAccess.User entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<MyERP.DataAccess.User>(httpStatusCode, entityToEmbed);
