...
{
    /// <summary>
    /// Web API Controller for CurrencyConvertRates entity defined in MyERP.DataAccess.EntitiesModel data model
    /// </summary>
    public partial class CurrencyConvertRatesController : OpenAccessBaseApiController<MyERP.DataAccess.CurrencyConvertRate, MyERP.DataAccess.EntitiesModel>
    {
        /// <summary>
        /// Constructor used by the Web API infrastructure.
        /// </summary>
        public CurrencyConvertRatesController()
        {
            this.repository = new CurrencyConvertRateRepository();
        }
        ...
        public CurrencyConvertRatesController(IOpenAccessBaseRepository<MyERP.DataAccess.CurrencyConvertRate , MyERP.DataAccess.EntitiesModel> repository)
        {
        ...
        public virtual MyERP.DataAccess.CurrencyConvertRate Get(Guid id)
        {
            MyERP.DataAccess.CurrencyConvertRate entity = repository.GetBy(m => m.Id == id);
        ...
        public virtual HttpResponseMessage Put(Guid id, MyERP.DataAccess.CurrencyConvertRate entity)
        {
                        if (entity == null ||
                id != entity.Id)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, MyERP.DataAccess.CurrencyConvertRate entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<MyERP.DataAccess.CurrencyConvertRate>(httpStatusCode, entityToEmbed);
