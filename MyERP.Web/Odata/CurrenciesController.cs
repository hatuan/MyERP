...
namespace MyERP.Web.Odata
{
    ...
    public partial class CurrenciesController : BaseApiController<MyERP.DataAccess.Currency, MyERP.DataAccess.EntitiesModel>
    {
        ...
        public CurrenciesController(IBaseRepository<MyERP.DataAccess.Currency , MyERP.DataAccess.EntitiesModel> repository)
        {
        ...
        public virtual MyERP.DataAccess.Currency Get(long id)
        {
        ...
        public virtual HttpResponseMessage Put(long id, MyERP.DataAccess.Currency entity)
        {
