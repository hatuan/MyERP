...
namespace MyERP.Web
{
    ...
    /// </summary>
    public partial class CurrenciesController : OpenAccessBaseApiController<MyERP.DataAccess.Currency, MyERP.DataAccess.EntitiesModel>
    {
        /// <summary>
        ...
        public CurrenciesController(IOpenAccessBaseRepository<MyERP.DataAccess.Currency , MyERP.DataAccess.EntitiesModel> repository)
        {
        ...
        public virtual MyERP.DataAccess.Currency Get(Guid id)
        {
            MyERP.DataAccess.Currency entity = repository.GetBy(m => m.Id == id);
        ...
        public virtual HttpResponseMessage Put(Guid id, MyERP.DataAccess.Currency entity)
        {
                        if (entity == null ||
                id != entity.Id)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, MyERP.DataAccess.Currency entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<MyERP.DataAccess.Currency>(httpStatusCode, entityToEmbed);
